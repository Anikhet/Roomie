...
function HomePage() {
  ...
  return (
    <main className="w-full h-full flex gap-0">
      ...
      <div className=" w-full h-full md:h-3/4 md:w-5/6 relative shrink-0 flex items-center justify-center">
        <img
          className="object-cover w-full h-full absolute top-0 left-0 z-0"
          src="/bg-image.png"
          alt="bg-image"
        />
        <h1 className="text-white uppercase absolute top-[50%] md:top-[55%] left-[10%] md:left-[22%] text-5xl leading-none font-bold md:text:lg">
          Time for <span className="text-black">Adventures</span> & Experiences
        </h1>
      </div>
    </main>
  );
